...
router.get('/leadership-assignments', ticketAssignmentNoticeController.getLeadershipAssignmentsList);
...
router.patch('/transfer-requests/:requestId/cancel', ticketTransferRequestController.cancelTransferRequest);
...
router.patch('/:id/cancel-request', ticketController.cancelRequesterTicket);
